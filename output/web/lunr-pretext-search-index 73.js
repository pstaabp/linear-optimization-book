...
},
{
  ...
  "number": "1.2.7",
  "title": "",
  "body": "Put the linear system from in a augmented coefficient matrix and using row operations to put the equation in reduced row-echelon form.  First, ensure that all of the variables are on the left of the equations in and the constants on the right. This can be written as the augmented coefficient matrix,     "
},
{
