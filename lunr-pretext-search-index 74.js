...
},
{
  ...
  "number": "1.2.7",
  "title": "",
  "body": "Put the linear system from in a augmented coefficient matrix and using row operations to put the equation in reduced row-echelon form.  First, ensure that all of the variables are on the left of the equations in and the constants on the right. This can be written as the augmented coefficient matrix,     Row operations are now done of this    "
},
{
...
},
{
  "id": "sect-tableau-6-5",
  "level": "2",
  "url": "sect-tableau.html#sect-tableau-6-5",
  "type": "Checkpoint",
  "number": "3.2.5",
  "title": "",
  "body": " Use Phase II of the Simplex method to find the optimal solution of  "
},
{
  "id": "sect-intro-ilops",
  "level": "1",
