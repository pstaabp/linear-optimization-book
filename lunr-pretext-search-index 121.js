...
},
{
  ...
  "number": "3.3.5",
  "title": "",
  "body": "  Apply Phase II of the Simplex Method to the last tableau from     For phase II, we first look in the objective row of the tableau and note that because there are negative numbers so the basic solution is not optimal.   "
},
{
  "id": "sect-intro-ilops",
  "level": "1",
